...
{
    public class JanrService : IJanrService
    {
        private readonly IUnitOfWork _unitOfWork;

        public JanrService(IUnitOfWork unitOfWork)
        {
        ...
        public void Create(AddJanrDto janrDto)
        {
            ...
            if (janrDto.Name.Length < 3 || janrDto.Name.Length > 30)
                throw new CustomExeption("Name", "Janr Name must be between 3 and 30 characters");
        ...
        public void Update(UpdateJanrDto janrDto)
        {
            ...
            if (janrDto.Name.Length < 3 || janrDto.Name.Length > 30)
                throw new CustomExeption("", "Janr Name must be between 3 and 30 characters");
